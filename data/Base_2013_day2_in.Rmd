...
This study investigates whether the most reputable Open Access journals have data sharing polices and the characteristics of those policies. These policies require authors, in some fashion, to openly disseminate the data and software underlying their published articles. FN-
...
The doaj_seal.csv data set will be copied and enhanced with additional columns, resulting in the processed data set, doaj_seal_enhanced.csv. The following columns will be added to doaj_seal.csv, in conformance with the Coding Framework of Castro et al (2017)
...
6
Journal article
Rendered output per publisher requirements
RMarkdown, 9 MB
Publisher website (open access) and community preprint server
